  ...
  describe 'POST /questions' do
    ...
    context 'autirized' do
      ...
      context 'with valid params' do
        let(:params) { {question: question, access_token: access_token.token} }

        it 'resonse with 201 status' do
          post '/api/v1/questions', params: params, as: :json
          expect(response).to have_http_status :created
        end

        it 'creates new question' do
          expect { post '/api/v1/questions', params: params, as: :json }.to change(Question, :count).by(1)
        end
      ...
      context 'with invalid params' do
        let(:params) { {question: invalid_question, access_token: access_token.token} }
        ...
        it "don't create new question" do
          expect { post '/api/v1/questions', params: params, as: :json }.not_to change(Question, :count)
        end
      end
    end
  end
