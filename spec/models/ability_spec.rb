    ...
    context 'Answer' do
      ...
      context 'select_best' do
        context 'user author of question' do
          ...
          it { is_expected.to be_able_to :select_best, other_user_answer, user: user }
          it { is_expected.to be_able_to :select_best, user_answer, user: user }
        end
        ...
        context 'user not author of question' do
          ...
          it { is_expected.not_to be_able_to :select_best, other_user_answer, user: user }
          it { is_expected.not_to be_able_to :select_best, user_answer, user: user }
        end
      end
